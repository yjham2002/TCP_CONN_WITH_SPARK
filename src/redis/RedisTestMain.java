...
//
//        Log.i(Arrays.toString(b.getByteSerial().getProcessed()));
...
//            Log.i("[]-".replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]").replaceAll("\\-", "\\\\-"));
            ...
            for(RealtimePOJO r : set){
                Log.i(cnt++ + Arrays.toString(r.getByteSerial().getProcessed()));
            }
...
//
//            Log.i(Arrays.toString(obj1.getByteSerial().getProcessed()));
//            Log.i(Arrays.toString(obj2.getByteSerial().getProcessed()));
//            Log.i(Arrays.toString(obj3.getByteSerial().getProcessed()));
//            Log.i(Arrays.toString(obj4.getByteSerial().getProcessed()));
//            Log.i(Arrays.toString(obj5.getByteSerial().getProcessed()));
        }catch(Exception e){
            e.printStackTrace();
        }
    }
