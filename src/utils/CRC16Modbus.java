...
/**
 * @author 함의진
 * 모드버스에 이용되는 CRC16 CheckSum 계산을 위한 클래스
 */
public class CRC16Modbus implements Checksum {
    ...
    /**
     * 직렬화된 바이트스트림으로부터 계속해서 합을 갱신하며 CRC16 값을 도출하는 클래스
     * @param b
     * @param off
     * @param len
     */
    ...
    /**
     * CRC 테스트를 위한 메인 - 제거해야 함
     * @param args
     */
    public static void main(String[] args) {
        CRC16Modbus crc = new CRC16Modbus();
        int[] data = new int[]{83, 79, 72, 65, 85, 78, 73, 70, 65, 82, 77, 48, 48, 55, 56};
        for (int d : data) {
            crc.update(d);
        }
