...
public class RealtimePOJO extends BasePOJO{
    ...
    public byte[] getWritableData(){
        byte[] check = SohaProtocolUtil.concat(
                ...
                new byte[]{(byte)getBitAggregationWithHint(mcnctrl_web_aggr, false, this.mcnctrl_web_order_main2, this.mcnctrl_web_order_main1, -1, this.mcnctrl_web_pause, this.mcnctrl_web_order_ilum, this.mcnctrl_web_order_humidity, this.mcnctrl_web_order_temp, this.getMcnctrl_web_order_co2())}
